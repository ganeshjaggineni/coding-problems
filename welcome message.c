...
requirement, Nikhil wanted to write a piece of code for his company’s Amphi
Event Management System that will welcome all the Customers who are using it.
Help Nikhil on the task.
Output Format:
...
int main()
{
char msg[100]="Welcome to Amphi Event Management System";
printf("%s",msg);
return 0;
}
